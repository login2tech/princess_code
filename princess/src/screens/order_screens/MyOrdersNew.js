...
class MyOrdersNew extends React.Component {
  goToList() {
  ...
  getListings() {
    ...
    fetch(
      endpoint +
        '?action=princess_user_orders&status=new&user_id=' +
...
export default connect(mapStateToProps)(MyOrdersNew);
