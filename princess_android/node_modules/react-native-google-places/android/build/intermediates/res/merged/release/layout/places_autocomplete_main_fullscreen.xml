...
<RelativeLayout
  ...
  <android.support.v7.widget.Toolbar
      android:id="@+id/places_autocomplete_action_bar"
      android:layout_width="match_parent"
      android:layout_height="wrap_content"
      android:background="?attr/colorPrimary"
      android:minHeight="?attr/actionBarSize"
      app:contentInsetEnd="@dimen/places_autocomplete_toolbar_inset_end"
      app:contentInsetLeft="@dimen/places_autocomplete_toolbar_inset_start"
      app:contentInsetRight="@dimen/places_autocomplete_toolbar_inset_end"
  ...
  <View
      ...
      android:layout_below="@+id/places_autocomplete_action_bar"
  ...
  <android.support.v7.widget.RecyclerView
      ...
      />
  <RelativeLayout
      android:id="@+id/places_autocomplete_error"
      android:layout_width="match_parent"
      android:layout_height="match_parent"
      android:layout_below="@+id/places_autocomplete_action_bar"
