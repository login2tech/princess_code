...
class ConfirmedOrders extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: false,
  ...
  getListings() {
    ...
    fetch(
      endpoint +
        '?action=princess_provider_orders&status=Confirmed&provider_id=' +
    ...
    return (
      <View style={[globalStyles.containerSplash, {backgroundColor: '#fff'}]}>
        ...
        >
          ...
          <View>
            <ScrollView>
             <View style={{backgroundColor:Colors.pinkBg2, padding:10,width:'100%', textAlign:'center',borderBottomWidth:1, borderBottomColor:'#000'}}><Text  style={{backgroundColor:Colors.pinkBg2,textAlign:'center'}}>{this.lang.CONFIRMED_ORDERS}</Text></View>
