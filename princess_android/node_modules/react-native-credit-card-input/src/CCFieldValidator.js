...
export default class CCFieldValidator {
  ...
  validateValues = (formValues) => {
    ...
    const validationStatuses = pick({
      ...
      address: !!formValues.address ? "valid" : "incomplete",
      city: !!formValues.city ? "valid" : "incomplete",
      state: !!formValues.state ? "valid" : "incomplete",
      country_code: !!formValues.country_code ? "valid" : "incomplete",
