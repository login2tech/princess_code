...
<FrameLayout
    ...
    android:id="@+id/places_autocomplete_overlay_root"
    android:layout_width="match_parent"
    android:layout_height="match_parent"
    android:padding="@dimen/places_autocomplete_overlay_padding"
    >
  <android.support.v7.widget.CardView
      android:id="@+id/places_autocomplete_overlay_content"
      android:layout_width="match_parent"
    ...
    <LinearLayout
      ...
      <!-- Separator below the search bar -->
      <View
          android:layout_width="match_parent"
